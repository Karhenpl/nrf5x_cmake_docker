...
macro(nRF5x_setup)
    ...
    elseif (NRF_TARGET MATCHES "nrf52")
        ...
        if(NOT DEFINED NRF5_LINKER_SCRIPT)
            set(NRF5_LINKER_SCRIPT "${NRF5_SDK_PATH}/config/${NRF52X_DEVICE_NAME}/armgcc/generic_gcc_nrf52.ld")
                # set(NRF5_LINKER_SCRIPT "${NRF5_SDK_PATH}/examples/ble_peripheral/ble_app_blinky/pca10040/s132/armgcc/ble_app_blinky_gcc_nrf52.ld")
        endif()
